...
if(isset($_GET["currency_id"])){
	$currency_id=slash($_GET["currency_id"]);
	$_SESSION["expense"]["list"]["currency_id"]=$currency_id;
}
if(isset($_SESSION["expense"]["list"]["currency_id"]))
	$currency_id=$_SESSION["expense"]["list"]["currency_id"];
else
	$currency_id="";
if($currency_id!=""){
	$extra.=" and currency_id='".$currency_id."'";
	$is_search=true;
}
