...
<div class="panel-body table-responsive">
	<table class="table table-hover list">
        ...
        <?php 
        $rs=doquery("select * from equipment where 1 $extra order by sortorder", $dblink);
        if(numrows($rs)>0){
            ?>
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr data-id="<?php echo $r[ "id" ]?>">
                        ...
                        <td class="text-center">
                            ...
                            <a href="equipment_manage.php?id=<?php echo $r['id'];?>&tab=status&s=<?php echo ($r["status"]==0)?1:0;?>" class="change_status_sortable">
                                <?php
                                if($r["status"]==0){
                                    ?>
                            ...
                            <a onclick="" class="delete_record_sortable" href="equipment_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete"><img title="Delete Record" alt="Delete" src="images/delete.png"></a>
                        </td>
                    </tr>
                    <?php 
                    $sn++;
