...
<form class="form-horizontal form-horizontal-left" role="form" action="expense_category_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd">
    <?php
        $i=0;
    ?>
