...
if(isset($_GET["q"])){
	$q=slash($_GET["q"]);
	$_SESSION["fuel_tank_manage"]["q"]=$q;
}
if(isset($_SESSION["fuel_tank_manage"]["q"]))
	$q=$_SESSION["fuel_tank_manage"]["q"];
else
	$q="";
if(!empty($q)){
...
<div class="page-header">
	<h1 class="title">Fuel Tank</h1>
  	<ol class="breadcrumb">
    	<li class="active">Manage Fuel Tank</li>
  	</ol>
  	<div class="right">
...
<div class="panel-body table-responsive">
	<table class="table table-hover list">
		...
		<?php 
        $rs=doquery("select * from fuel_tank where 1 $extra order by sortorder", $dblink);
        if(numrows($rs)>0){
            ?>
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr data-id="<?php echo $r[ "id" ]?>">
                        ...
                        <td class="text-center">
                            ...
                            <a href="fuel_tank_manage.php?id=<?php echo $r['id'];?>&tab=status&s=<?php echo ($r["status"]==0)?1:0;?>" class="change_status_sortable">
                                <?php
                                if($r["status"]==0){
                                    ?>
                            ...
                            <a onclick="" class="delete_record_sortable" href="fuel_tank_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete"><img title="Delete Record" alt="Delete" src="images/delete.png"></a>
                        </td>
                    </tr>
                    <?php 
                    $sn++;
