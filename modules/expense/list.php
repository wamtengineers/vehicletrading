    ...
    <li class="col-xs-12 col-lg-12 col-sm-12">
    	<div>
        	<form class="form-horizontal" action="" method="get">
                ...
                <div class="col-sm-2">
                  <select name="currency_id" id="currency_id" class="custom_select">
                        <option value=""<?php echo ($currency_id=="")? " selected":"";?>>Select Currency</option>
                        <?php
                            $res=doquery("select * from currency order by id",$dblink);
                            if(numrows($res)>=0){
                                while($rec=dofetch($res)){
                                ?>
            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php echo curr_format(unslash($r["amount"]))." ".get_field( unslash($r["currency_id"]), "currency", "symbol" ); ?></td>
