	...
	<div id="wrapper" class="round_corners">		
            ...
            <ul class="top-right">
            	<li class="dropdown link">
                    ...
                    <ul class="dropdown-menu dropdown-menu-list dropdown-menu-right">
                        ...
                        <li><a href="profile.php"><i class="fa falist fa-file-o"></i>Edit Profile</a></li>
        ...
        <div class="sidebar clearfix">
            ...
            <ul class="sidebar-panel nav">
                ...
                <li><a href="profile.php"><span class="icon color15"><i class="fa fa-columns"></i></span>Edit Profile</a></li>
